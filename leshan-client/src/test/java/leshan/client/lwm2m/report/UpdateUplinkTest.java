...
public class UpdateUplinkTest {
	...
	public ReportUplink initializeServerResponse(final InterfaceTypes interfaceType, final OperationTypes operationType, final ResponseCode responseCode){
		...
		final ReportUplink uplink = new ReportUplink(endpoint);
		return uplink;
	}
	...
	public void testGoodSyncUpdate() {
		...
		final ReportUplink uplink = initializeServerResponse(InterfaceTypes.REGISTRATION, OperationTypes.UPDATE, ResponseCode.CHANGED);
	...
	public void testBadParametersSyncUpdate() {
		final ReportUplink uplink = initializeServerResponse(InterfaceTypes.REGISTRATION, OperationTypes.UPDATE, ResponseCode.BAD_REQUEST);
