 ...
 * ClientHello message. The message flow is depicted in <a href="http://tools.ietf.org/html/rfc5246#section-7.3">Figure
 * 2</a>. The new keys will be generated from the master secret established from a previous full handshake.
 */
public class ResumingClientHandshaker extends ClientHandshaker {
    ...
    /**
     * When the client received the server's finished message, it verifies the finished message and sends the third and
     * last flight of the short handshake: it contains the ChangeCipherSpec and the Finished message.
     * 
     * @param message the server's finished message.
     * @return the last flight of the short handshake.
     * @throws HandshakeException if the server's Finished message could not be verified.
     */
