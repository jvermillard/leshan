...
public class CreateTest {
    ...
    public void can_create_instance_of_object() {
        ...
        // create ACL instance
        LwM2mObjectInstance data = new LwM2mObjectInstance(0, new LwM2mResource[0]);
    ...
    public void can_create_specific_instance_of_object() {
        ...
        LwM2mObjectInstance data = new LwM2mObjectInstance(0, new LwM2mResource[] { accessControlOwner });
        CreateResponse response = helper.server.send(helper.getClient(), new CreateRequest(2, 0, data, null));
    ...
    public void cannot_create_instance_of_object() {
        ...
        LwM2mObjectInstance data = new LwM2mObjectInstance(0, new LwM2mResource[0]);
        CreateResponse response = helper.server.send(helper.getClient(), new CreateRequest(50, 0, data, null));
    ...
    public void cannot_create_instance_without_all_required_resources() {
        ...
        // create ACL instance
        LwM2mObjectInstance data = new LwM2mObjectInstance(0, new LwM2mResource[] {});
        CreateResponse response = helper.server.send(helper.getClient(), new CreateRequest(2, 0, data, null));
    ...
    public void cannot_create_mandatory_single_object() {
        ...
        LwM2mObjectInstance data = new LwM2mObjectInstance(3, new LwM2mResource[0]);
        CreateResponse response = helper.server.send(helper.getClient(), new CreateRequest(3, 0, data, null));
